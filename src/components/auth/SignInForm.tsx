      ...
      <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
        <div className="mb-5 sm:mb-8">
          ...
          <p className="text-sm text-gray-500">
            Masukkan email dan password anda untuk sign in!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-3 sm:gap-5">
          <button
            ...
            className="inline-flex items-center justify-center gap-3 py-3 text-sm bg-gray-100 rounded-lg hover:bg-gray-200"
          >
        ...
        <div className="relative py-3 sm:py-5">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="p-2 text-gray-400 bg-white">Or</span>
          </div>
        </div>
